...
public class Challenge_02 {
    ...
    /**
     * For the solution I created a new hash map to store the nums in the array, them I iterated over the nums arr and in eahc iteration I first
     ...
     * as a key and if so I returned a new array with the value of the key, that is the index, and the current index, if the map does not contain the
